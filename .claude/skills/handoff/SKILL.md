...
Write a handoff file at `docs/handoffs/YYYY-MM-DD-<short-topic>.md` (use today's date). Keep it under 120 lines, and prefer shorter — the previous guidance was 60 and every recent handoff blew past it, so treat 120 as a real ceiling rather than a target. Cut narration, not facts. Use exactly this structure:
